...
type Laptop struct {
	...
	// Types that are assignable to Wight:
	//
	//	*Laptop_WeightKg
	//	*Laptop_WeightLb
	Wight       isLaptop_Wight       `protobuf_oneof:"wight"`
...
func (m *Laptop) GetWight() isLaptop_Wight {
	if m != nil {
		return m.Wight
	}
	return nil
...
func (x *Laptop) GetWeightKg() float64 {
	if x, ok := x.GetWight().(*Laptop_WeightKg); ok {
		return x.WeightKg
	}
	return 0
}
...
func (x *Laptop) GetWeightLb() float64 {
	if x, ok := x.GetWight().(*Laptop_WeightLb); ok {
		return x.WeightLb
	}
	return 0
}
...
func (*Laptop_WeightKg) isLaptop_Wight() {}

func (*Laptop_WeightLb) isLaptop_Wight() {}
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x03, 0x0a, 0x06, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12,
	...
	,
	...
	0x05, 0x77, 0x69, 0x67, 0x68, 0x74, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62, 0x62, 0x06,
...
var file_laptop_message_proto_goTypes = []interface{}{
	(*Laptop)(nil),              // 0: pc_book.Laptop
	(*CPU)(nil),                 // 1: pc_book.CPU
	(*Memory)(nil),              // 2: pc_book.Memory
	(*GPU)(nil),                 // 3: pc_book.GPU
	(*Storage)(nil),             // 4: pc_book.Storage
	(*Screen)(nil),              // 5: pc_book.Screen
	(*Keyboard)(nil),            // 6: pc_book.Keyboard
	(*timestamp.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: pc_book.Laptop.cpu:type_name -> pc_book.CPU
	2, // 1: pc_book.Laptop.ram:type_name -> pc_book.Memory
	3, // 2: pc_book.Laptop.gpus:type_name -> pc_book.GPU
	4, // 3: pc_book.Laptop.storages:type_name -> pc_book.Storage
	5, // 4: pc_book.Laptop.screen:type_name -> pc_book.Screen
	6, // 5: pc_book.Laptop.keyboard:type_name -> pc_book.Keyboard
	7, // 6: pc_book.Laptop.updated_at:type_name -> google.protobuf.Timestamp
