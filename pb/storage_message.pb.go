...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=pc_book.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x28, 0x0e, 0x32, 0x17, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x74, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x63, 0x5f, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: pc_book.Storage.Driver
	(*Storage)(nil),     // 1: pc_book.Storage
	(*Memory)(nil),      // 2: pc_book.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: pc_book.Storage.driver:type_name -> pc_book.Storage.Driver
	2, // 1: pc_book.Storage.memory:type_name -> pc_book.Memory
